const banners = {
  'course-ansible': {
    content: 'Курс по Ansible с практикой прямо в браузере',
    link: 'https://ru.hexlet.io/courses/ansible',
  },
  'intensive-devops': {
    content: 'Интенсив: Девопс для программистов. Вся база за 3 месяца',
    link: 'https://ru.hexlet.io/programs/devops-for-programmers',
  },
  'profession-java': {
    content: 'Профессия «Java-разработчик» с нуля и до трудоустройства',
    link: 'https://ru.hexlet.io/programs/java',
  },
  'profession-frontend': {
    content: 'Профессия «Фронтенд-разработчик» с нуля и до трудоустройства',
    link: 'https://ru.hexlet.io/programs/frontend',
  },
  'profession-markup': {
    content: 'Профессия «Верстальщик» на Хекслете',
    link: 'https://ru.hexlet.io/programs/layout-designer',
  },
  'profession-php': {
    content: 'Профессия «PHP-разработчик» с нуля и до трудоустройства',
    link: 'https://ru.hexlet.io/programs/php',
  },
  'course-git': {
