...
Такое случается с популярными языками, имеющими долгую историю. Разные версии языка называют его *диалектами*. Услышав фразу «язык Clojure является диалектом Lisp», вы сразу понимаете, что Clojure — одна из современных разновидностей старого доброго Lisp.
