...
<div class="alert alert-warning mb-4" style="font-size:1rem;" role="alert">
  <strong>В этом гайде описан Bootstrap 4.</strong> Текущая публичная версия — 3.7. Версия 4 сейчас в стадии «альфа», и скоро будет публичный релиз. Идеи и принципы в обеих версиях едины, но детали отличаются.
</div>
