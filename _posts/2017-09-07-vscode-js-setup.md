...
![install package in vs code](/images/vscode-install.png)
...
![eslint atom](/images/vscode_eslint.png)
...
В отличие от редактора Атом, VS Code содержит мощную систему анализа кода для автодополнений и подсказок – [IntelliSense](https://code.visualstudio.com/docs/editor/intellisense).
...
Если положить в корень директории с JavaScript-проектом файл конфигурационный файл `jsconfig.json`, то VS Code будет использовать эту конфигурацию для работы с вашим проектом. Вот пример такого файла:
...
![vs code debugging](/images/javascript_debug_data_inspection.gif)
