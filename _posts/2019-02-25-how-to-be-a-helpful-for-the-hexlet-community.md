...
subtitle:
summary: Помощь ученикам, создание контента, Опенсорс
cover_url: "Путь к файлу-обложке для соц. сетей, например, /images/vscode_eslint.png"
---

Хекслет — не просто школа программирования. Это большое и [дружелюбное комьюнити](http://slack-ru.hexlet.io) с более чем 12 тысячами участников. Многих мы знаем лично, встречаемся, ходим на скалодром и вместе разрабатываем открытые проекты.
...
#### [guides.hexlet.io](https://guides.hexlet.io/)
...
#### [codebattle.hexlet.io](https://codebattle.hexlet.io/)
...
#### [cv.hexlet.io](https://cv.hexlet.io/)

[HexletCV](https://cv.hexlet.io/) — опенсорс-проект для соискателей и HR-специалистов. Кандидаты публикуют на сайте резюме, а опытные эйчары рекомендуют, как улучшить эти документы. В проекте используется Ruby on Rails. 
...
* участие в разработке [сервиса](https://cv.hexlet.io/);
* анализ резюме соискателей и рекомендации по улучшению.

Задачи можно обсудить в канале #hexlet-volunteers в [Slack-сообществе](http://slack-ru.hexlet.io/).

#### [hexlet-interview](https://hexlet-interview.herokuapp.com/)

[HexletInterview](https://hexlet-interview.herokuapp.com/) — проект с открытым исходным кодом для желающих пройти публичное собеседование. Кандидат оставляет заявку, с ним связывается интервьюер и проводит собеседование в прямом эфире. Трансляция проходит на канале «Хекслета» в YouTube. Проект работает на Node.js.

Ссылки:

* [исходный код](https://github.com/Hexlet/hexlet-interview).

Задачи:

* участие в разработке [сервиса](https://hexlet-interview.herokuapp.com/);
* проведение публичных собеседований.

Подробности узнавайте в канале #hexlet-volunteers в [Slack-сообществе](http://slack-ru.hexlet.io/).

#### [hexlet-sicp](https://hexlet-sicp.herokuapp.com/)

[Hexlet SICP](https://hexlet-sicp.herokuapp.com/) — трекер прохождения СИКП. Участники отмечают пройденные материалы, отслеживают прогресс других пользователей. Проект работает на Laravel. 
...
* участие в разработке [сервиса](https://hexlet-sicp.herokuapp.com/);
* изучение СИКП и популяризация курса и сервиса :-)

Обсудить задачи можно в канале #hexlet-volunteers в [Slack-сообществе](http://slack-ru.hexlet.io/).

#### [hexlet-correction](https://hexlet-correction.herokuapp.com/)

[Hexlet Corrections](https://hexlet-correction.herokuapp.com/) — сервис уведомления владельцев сайтов об ошибках и опечатках. После интеграции с сайтом посетители получают возможность выделить ошибку или опечатку и сообщить о ней администратору. Проект работает на Java. 
...
* участие в разработке [сервиса](https://hexlet-correction.herokuapp.com/).

Подробности можно узнать в канале #hexlet-volunteers в [Slack-сообществе](http://slack-ru.hexlet.io/).
...
Обсуждение в канале #hexlet-volunteers в [Slack-сообществе](http://slack-ru.hexlet.io/).
...
#### [Вопросы/Ответы](https://ru.hexlet.io/my/topics)
...
1. Процесс обучения. Ваши мысли, открытие, сложности с которыми столкнулись. В сообществе есть запрос на такие посты. Все хотят знать, что они не одни и не только им сложно. Пример — https://ru.hexlet.io/blog/posts/professions-php-greybutton 
1. Полезные статьи на любую тематику, имеющую отношение к нашей аудитории. Пример — https://ru.hexlet.io/blog/posts/developers-business-value
...
#### [Испытания](https://ru.hexlet.io/challenges)
...
#### [Отзывы](ru.hexlet.io/testimonials)
...
### [Youtube](https://www.youtube.com/channel/UCqLPYxuAz-WbdEBLBk_Tb7g)
...
В чате можно проводить слаконары на актуальные для участников темы. [Пример](https://github.com/Hexlet/hexlet-slack-archive/wiki/%5B2019-08-05%5D-%D0%A1%D0%BB%D0%B0%D0%BA%D0%BE%D0%BD%D0%B0%D1%80-%D1%81-HR-%D1%8D%D0%BA%D1%81%D0%BF%D0%B5%D1%80%D1%82%D0%BE%D0%BC.-%D0%A0%D0%B0%D0%B7%D0%B1%D0%B8%D1%80%D0%B0%D0%B5%D0%BC-%D1%80%D0%B5%D0%B7%D1%8E%D0%BC%D0%B5-%D1%81%D1%82%D1%83%D0%B4%D0%B5%D0%BD%D1%82%D0%BE%D0%B2-Hexlet).
### Свой город
