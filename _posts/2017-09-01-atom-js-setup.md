...
![install package in atom](/images/eslint.png)
...
![eslint atom](/images/eslint-atom.png)
...
Встроенное автодополнение в редакторе работает по самой примитивной схеме, анализирую содержимое файлов. С помощью сторонней утилиты "tern" можно добиться более продвинутого поведения. "tern" умеет:
...
![autocomplete-modules](/images/autocomplete-modules.gif)

### Переход на определения

[js-hyperclick](https://atom.io/packages/js-hyperclick) позволяет быстро перемещаться к определению функции или переменной с помощью по клику.

![js-hyperclick](/images/js_hyperclick.png)
