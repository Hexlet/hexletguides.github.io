...
Поиск — это хорошо, но никогда не забывайте про официальную документацию используемых инструментов (в том числе языков программирования). Как правило, они включают в себя не только сухое описание функций, но и гайды, которые стоит изучить полностью.
